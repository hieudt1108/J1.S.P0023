...
public class Manager {
    ...
    static void viewOrder( ArrayList<Customer> ht) {
        for (Customer customer : ht) {
            System.out.println("Customer: " + customer.getName());
            ArrayList<Order> lo = customer.getList();
            displayListOrder(lo);
        }
    }

    //allow user buy items
    static void shopping(ArrayList<Fruit> lf, ArrayList<Customer> ht) {
